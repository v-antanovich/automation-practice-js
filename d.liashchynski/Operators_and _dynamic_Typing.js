...
/*
1. Сначала сравниваем '3 && cola' - результат false
2. Далее сравниваем '3 && nuggets' - результат 2, т.е. true
3. В результате сравниваем 'hamburger === false (результат false) || fries === true (результат true)'. 
Т.к. логический оператор || возвращает первое истинное значение, то результатом сравнения 'false || true' будет true.
